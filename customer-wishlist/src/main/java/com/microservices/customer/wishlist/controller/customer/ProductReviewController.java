package com.microservices.customer.wishlist.controller.customer;
...
import com.microservices.customer.wishlist.service.ProductReviewService;
...
public class ProductReviewController {
    ...
    @PostMapping   // http://localhost:8080/reviews?userId=101&productId=4&reviewContent=Great product!&rating=5
    public ResponseEntity<String> createReview(@RequestParam Long userId, 
